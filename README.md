...
Use TDD to create Item, Attendee, & Auction that will respond to the interaction pattern below.  Tests have already been written for object creation - you will need to write additional tests for methods starting with `add_item`.
